            ...
            <div class="row layout-top-spacing">
                <div id="tableProgress" class="col-lg-12 col-12 layout-spacing">
                    ...
                    <div class="statbox widget box box-shadow"
                        v-if="isShowEdit == false && isShowAdd == false && isShowDetail == false">
                                        ...
                                        <tr v-for="item in warehouseFilte" :key="item.iD">
                                            ...
                                            <td class="text-center">
                                                <a href="javascript:void(0);" data-toggle="tooltip" data-placement="top"
                                                    title="" data-original-title="Detail" style="padding: 20px;"
                                                    v-on:click="onDetail(item)"><svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    <a href="" v-if="isShowEdit == true || isShowAdd == true || isShowDetail == true"
                    ...
                    <WareHouseDetail :warehouse="showDetail" v-if="isShowDetail == true"
                        @ShowDetailData="getDetail($event)" />
