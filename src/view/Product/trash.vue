        ...
        <div class="widget-header">
            <div class="row">
                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                    <h4>Trash Product Management</h4>
                </div>
            </div>
        </div>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody v-if="query">
                        <tr v-for="item in productFilte" :key="item.id">
                            ...
                            <td><img :src="'http://localhost:54195/images/' + item.images" style="width: 100px" /></td>
                            ...
                            <td class="text-center">
                                <a href="javascript:void(0);" data-toggle="tooltip" data-placement="top" title=""
                                    data-original-title="Edit" style="padding: 0;
    margin-right: 10px;" v-on:click="onEdit(item)"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                ...
                                <a href="javascript:void(0);" data-toggle="tooltip" data-placement="top" title=""
                                    data-original-title="Edit" style="padding: 0;
    margin-right: 10px;" v-on:click="onRepeat(item)"><svg enable-background="new 0 0 64 64" viewBox="0 0 64 64"
            ...
            for (let i = 0; i < this.product.length; i++) {
                if (this.product[i].id == data.id ) {
                    if(this.product[i].status == false){
                        ...
                        this.product.splice(this.product.findIndex(e => e.id == data.id), 1).push(this.product[i]);
                    }
