            ...
            <div class="row">
                ...
                <div class="col-xl-6 col-lg-6 col-sm-6">
                    <div class="form-group">
                        <label for="exampleFormControlInput1" class="col-xl-12 col-sm-12 col-sm-12 col-form-label">Product
                            Code</label>
                        <div class="col-xl-12 col-lg-12 col-sm-12">
                    ...
                    <div class="form-group">
                        <label for="hPassword" class="col-xl-12 col-sm-12 col-sm-12 col-form-label">Product Name</label>
                        <div class="col-xl-12 col-lg-12 col-sm-12">
                    ...
                    <div class="form-group">
                        <label for="hPassword" class="col-xl-12 col-sm-12 col-sm-12 col-form-label">Description</label>
                        <div class="col-xl-12 col-lg-12 col-sm-12" >
                            <textarea style="width: 100%;" name="" id="description" cols="50" rows="10" placeholder="Click..." v-model="product.description" :class="{ error: descriptionError.status, success: descriptionSuccess.status }">
                ...
                <div class="col-xl-6 col-lg-6 col-sm-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xl-12 col-lg-12 col-sm-12">
                            <input type="text" class="form-control" id="price" placeholder="" v-model="product.price" :class="{ error: priceError.status, success: priceSuccess.status }">
                    ...
                    <div class="form-group">
                        <label for="hPassword" class="col-xl-12 col-sm-12 col-sm-12 col-form-label">SalePrice</label>
                        <div class="col-xl-12 col-lg-12 col-sm-12">
                            <input type="text" class="form-control" id="salePrice" placeholder="" v-model="product.salePrice" :class="{ error: salePriceError.status, success: salePriceSuccess.status }">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xl-12 col-lg-12 col-sm-12">
                            <input type="number" class="form-control" id="quantity" placeholder="" v-model="product.quantity" :class="{ error: quantityError.status, success: quantitySuccess.status }">
                    ...
                    <div class="row">
                        <div class="col-lg-12" style="display: flex;">
                            <div class="col-lg-6" style="padding: 0;">
                                <div class="form-group">
                                    <label for="hPassword" class="col-xl-12 col-sm-12 col-sm-12 col-form-label">Category</label>
                                    <div class="col-xl-12 col-lg-12 col-sm-12">
                                        <select class="form-control basic" name="" id="categoryId" v-model="product.categoryId">
                                            <option value="">Choose</option>
                                            <option v-for="item in categorys" :key="item.id" :selected="product.categoryId === item.id" v-bind:value="item.id">{{ item.name }}</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6" style="padding: 0;">
                                <div class="form-group ">
                                    <label for="hPassword" class="col-xl-12 col-sm-12 col-sm-12 col-form-label">WareHouse</label>
                                    <div class="col-xl-12 col-lg-12 col-sm-12">
                                        <select class="form-control basic" name="" id="wareHouseID" v-model="product.wareHouseID">
                                            <option value="">Choose</option>
                                            <option v-for="item in warehouses" :key="item.id" :selected="product.wareHouseID === item.id" v-bind:value="item.id">{{ item.name }}
                                            </option>
                                        </select>
                                    </div>
                                </div>
